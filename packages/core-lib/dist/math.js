 ...
 */
export function sqrtPriceX96ToRawPrice(sqrtPriceX96) {
 ...
 */
export function priceToSqrtPriceX96WithDecimals(price, decimals0, decimals1) {
 ...
 */
export function roundTickDown(tick, tickSpacing) {
    return Math.floor(tick / tickSpacing) * tickSpacing;
}
/**
 * Round tick up to nearest tick spacing
 */
export function roundTickUp(tick, tickSpacing) {
 ...
 */
export function getTickSpacingForFee(fee) {
    switch (fee) {
        case 100: return 1;
        case 500: return 10;
        case 3000: return 60;
 ...
 */
export function getFullRangeTicks(fee) {
 ...
 * Validate fee tier
 */
export function isValidFeeTier(fee) {
 ...
 */
export function calculateLiquidityFromAmounts(sqrtPriceX96, sqrtPriceLower, sqrtPriceUpper, amount0, amount1) {
    if (sqrtPriceX96 <= sqrtPriceLower) {
        ...
        if (liquidity0 === BigInt(0))
            return liquidity1;
        if (liquidity1 === BigInt(0))
            return liquidity0;
 ...
 */
export function calculateAmountsFromLiquidity(sqrtPriceX96, sqrtPriceLower, sqrtPriceUpper, liquidity) {
 ...
 */
export function calculateAmountsFromLiquidityWithTicks(sqrtPriceX96, tickLower, tickUpper, liquidity) {
 ...
 */
export function isPositionInRange(currentTick, tickLower, tickUpper) {
 ...
 */
export function getPositionRangePercentage(currentTick, tickLower, tickUpper) {
 ...
 */
export function calculatePoolShare(positionLiquidity, totalLiquidity) {
 ...
 */
export function estimatePositionValue(sqrtPriceX96, tickLower, tickUpper, liquidity, decimals0, decimals1) {
    const { amount0, amount1 } = calculateAmountsFromLiquidityWithTicks(sqrtPriceX96, tickLower, tickUpper, liquidity);
 ...
 */
export function calculateV2AmountOut(amountIn, reserveIn, reserveOut) {
 ...
 */
export function calculateV2AmountIn(amountOut, reserveIn, reserveOut) {
 ...
 */
export function calculateV2Price(reserve0, reserve1, decimals0, decimals1) {
